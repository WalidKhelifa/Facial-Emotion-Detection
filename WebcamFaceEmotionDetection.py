...
# get webcam and capture the video
...
while True:
    ...
    for index,current_face_location in enumerate(all_face_locations):
        ...
        #Sauvegarder la capture d'image de la video pour la predire
        ...
        cv2.putText(current_frame, emotion_label, (left_pos+105,bottom_pos+25), font, 1, (255,255,255),2)
        
    #showing the current face with rectangle drawn
    cv2.imshow("Emotion Walid detecion",current_frame)
